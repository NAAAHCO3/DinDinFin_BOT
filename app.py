...
from core.container import transaction_service, category_service, account_service
...
def start_bot():
    ...
    # Inicia o modo de escuta (Polling)
    # stop_signals=None evita conflitos com o encerramento do container no GCP
